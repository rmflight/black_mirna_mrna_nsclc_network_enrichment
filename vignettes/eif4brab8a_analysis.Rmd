...
setNodeLabelDirect(cw.eifrab, eifNodes, nodeData(eifGraph, eifNodes, "SYMBOL"))
redraw(cw.eifrab)
...
```{r exportEIFData}
write.table(eifInfo, file="~/Projects/work/black_lab//eif4brab8a/eifInfo.tab", row.names=FALSE, col.names=TRUE, sep="\t")
write.table(eifNewInfo, file="~/Projects/work/black_lab//eif4brab8a/eifInfoCollapsed.tab", row.names=FALSE, col.names=TRUE, sep="\t")
```
