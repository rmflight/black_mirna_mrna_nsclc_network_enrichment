...
Because we don't have direct access to STRING's translations, lets use a STRINGdb instance to do mapping to STRING IDs.
...
```{r translate2String}
useMRNA_mapped <- string_db$map(outMRNA, "SYMBOL", removeUnmappedRows=TRUE)
